...
const Cart = () => {
    ...
    const {products, currency, removeFromCart, getcartcount, updateCart, navigate, getcartamount,cartItems, axios, user, setCartItems} = useAppContext();
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress ? `${selectedAddress.street}, ${selectedAddress.city}, ${selectedAddress.state}, ${selectedAddress.zip}` : "No address found"}</p>
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate("/add-address")} className="text-[#4fbf8b] text-center cursor-pointer p-2 hover:bg-[44ae7c]/10">
                                    Add address
                                </p>
                            </div>
                        )}
